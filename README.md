...
JRA-VAN Data Lab.を採用しました。Windows上のJV-Linkで取得し、共通形式へ変換してから学習基盤へ渡します。
VercelからJV-Linkを直接実行しません。構成と未実装範囲は [JRA-VAN接続方針](docs/jra-van-source.md) を参照してください。
...
## 次の工程
1. JRA-VAN Data Lab.契約、SDK、JV-LinkをWindowsへ導入
2. JV-Link取得クライアントと共通形式への変換処理を実装
